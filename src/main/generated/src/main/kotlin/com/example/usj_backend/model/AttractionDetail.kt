...
import com.example.usj_backend.model.AttractionDetailAllOfOperatingHours
 ...
 * @param heightRestriction 
 * @param duration 
 * @param capacity 
 * @param fastPassAvailable 
 * @param accessibility 
...
data class AttractionDetail(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("category") val category: AttractionDetail.Category? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("area") val area: AttractionDetail.Area? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("detailedDescription") val detailedDescription: kotlin.String? = null,

    @get:Min(0)
    @Schema(example = "null", description = "")
    @get:JsonProperty("heightRestriction") val heightRestriction: kotlin.Int? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("fastPassAvailable") val fastPassAvailable: kotlin.Boolean? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("accessibility") val accessibility: kotlin.collections.List<kotlin.String>? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("operatingHours") val operatingHours: AttractionDetailAllOfOperatingHours? = null
    ) {
