...
data class Profile(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("visitFrequency") val visitFrequency: Profile.VisitFrequency? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("preferredAreas") val preferredAreas: kotlin.collections.List<Profile.PreferredAreas>? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("isVisible") val isVisible: kotlin.Boolean? = true,
